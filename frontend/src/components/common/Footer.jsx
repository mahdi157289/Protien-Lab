...
const Footer = () => {
  return (
    <footer
    className="bg-black text-white py-8 bg-cover bg-center "
    style={{
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-2">
            ...
            <img src={logo} alt="BodySync Logo" className="w-30 h-12" />
            </div>
        ...
        <div className="mt-8 pt-8 border-t-2 border-gray-800 flex flex-col md:flex-row justify-between items-center">
